...
while correcto and n_pregunta < 3*p_level:
    ...
    if n_pregunta == 0:
        ...
        while validate('y', continuar):
            ...
            respuesta = -1
            while not validate([chr(65+index) for index, i in enumerate(alternativas)],respuesta):
            ...
            if correcto and n_pregunta < 3*p_level:
                ...
                continuar = ""
                while not validate(['y','n'],continuar):
